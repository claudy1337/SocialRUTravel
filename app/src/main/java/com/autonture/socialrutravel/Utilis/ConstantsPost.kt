...
object ConstantsPost {
    fun getPostData():ArrayList<PostClass> {
        ...
        val post1 = PostClass("1",  "Aboba Boba", "aboba_boba", "Внезапно, представители современных социальных резервов преданы социально-демократической анафеме...", R.drawable.backround_image2)
        postList.add(post1)
        ...
        postList.add(post3)
        val post4 = PostClass("4",  "Shmoney Boba", "aboba_boba", "Внезапно, представители современных социальных резервов преданы социально-демократической анафеме...", R.drawable.backround_image2)
        postList.add(post4)
